 ...
 * 
 * Paw draw editors are used for `.imageEditor` files, which are just `.png` files with a different file extension.
 * 
 ...
 */
export class ImageEditorProvider implements vscode.CustomEditorProvider<PawDrawDocument> {
	...
	private static readonly viewType = 'nilogy.imageEditor';
	...
	private getHtmlForWebview(webview: vscode.Webview): string {
		...
		const scriptUri = webview.asWebviewUri(vscode.Uri.file(
			path.join(this._context.extensionPath, 'media', 'imageEditor.js')
		));
		const styleUri = webview.asWebviewUri(vscode.Uri.file(
			path.join(this._context.extensionPath, 'media', 'imageEditor.css')
		));
		...
		return /* html */`
			...
			<head>
				...
				<title>VSCode Image Editor</title>
			</head>
			<body>
				<div class="drawing-canvas"></div>
				<div class="drawing-controls">
					<input type="text" id="currentcolortext" value="">
					<input type="color" id="currentcolor" />
					<button data-action="pickcolorfromimage"><img src="${mediaUri}/imgs/colorpicker.png"></button>
					<button data-action="pen"><img src="${mediaUri}/imgs/pen.png"></button>
				</div>
